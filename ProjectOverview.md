...
- **Docker containerization** for homelab deployment
...
services:
  ...
  app:
    ...
    depends_on:
      - postgres
    environment:
      DATABASE_URL: postgresql://${DB_USER}:${DB_PASSWORD}@postgres:5432/dnd_characters
...
DATABASE_URL=postgresql://dnd_user:secure_password_here@localhost:5432/dnd_characters
...
BACKUP_DIR="/backups"
DB_NAME="dnd_characters"

# Database backup
pg_dump $DATABASE_URL > "$BACKUP_DIR/db_backup_$DATE.sql"

# Character data backup (JSON export)
node scripts/export-characters.js > "$BACKUP_DIR/characters_$DATE.json"
